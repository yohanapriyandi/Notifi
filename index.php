...
<html lang="en">
  <head>
    ...
    <title>PHP Notification System</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown">
            <a class="nav-link" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Notifications 
                ...
                ?>
                <span class="badge badge-primary"><?php echo count(fetchAll($query)); ?></span>
              <?php
                }
                    ?>
              </a>
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a style ="
                ...
                if($i['type']=='comment'){
                    echo "nootifications one.";
                }else if($i['type']=='like'){
                    echo ucfirst($i['name'])." notifications two.";
                }
        ...
        <form method="post" class="form-inline my-2 my-lg-0">
          ...
          <button name="submit" class="btn btn-outline-info my-2 my-sm-0" type="submit">Submit</button>
        </form> |
          <?php
        ...
        <form method="post" class="form-inline my-2 my-lg-0">
          ...
          <button name="like" class="btn btn-outline-primary my-2 my-sm-0" type="submit">Like  </button>
        </form>
      </div>
    </nav>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        ...
        <p class="lead">
                 We assumption.
            <br> user is logged on system, the user can see notification on header like on example.
            <br> you can customize this notification with your issue / project your on work.        
        </p>
      </div>
